...
def get_user_repos(username):
    ...
    for repo in repos:
        ...
        repo_info.append({
            ...
            "contents": None,  # Avoid fetching contents for now
        })
...
def main():
    ...
    st.sidebar.title("Mercor ML Coding Challenge")
    ...
    st.divider()
    st.sidebar.write("Made with ❤️ by [Sanjay](https://github.com/i-sanjay-cs).")
